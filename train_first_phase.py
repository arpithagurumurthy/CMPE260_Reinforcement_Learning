...
parser.add_argument('--window_size', action="store", dest="window_size", default=2, type=int, help="span (days) of observation")
parser.add_argument('--num_episode', action="store", dest="num_episode", default=2, type=int, help='episode number')
...
# E.g Say you have 100 days worth of stock data
# Trading period is 100 days because you get to explore for 100 days.
...
def hold(actions):
    ...
    # {0: 'Hold', 1: 'Buy', 2: 'Sell'}
    ## To-Do Find out what np.argsort(actions)[1] does
    ##Changing from 1 to 2 --> sell
...
def buy(t):
    if agent.balance > stock_prices[t]:
        ...
        # inventory would contain all the buying prices of the stocks thats bought
...
# configure logging
logging.basicConfig(filename=f'logs/{model_name}_training_first_phase_{stock_name}.log', filemode='w',
...
# Reset the agent in every episode
    ...
    if e % 2 == 0:
        agent.model.save('saved_models/DQN_FB_ep_first_draft' + str(e) + '.h5')
