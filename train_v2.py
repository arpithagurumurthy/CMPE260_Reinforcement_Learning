...
parser.add_argument('--model_name', action="store", dest="model_name", default='DQN_v2', help="model name")
parser.add_argument('--stock_name', action="store", dest="stock_name", default='FB_2016-2021', help="stock name")
...
def buy(t):
    ...
    # else:
    #     logging.info("Trying to buy when balance is less than stock price")
    #     reward = -10000
...
def sell(t):
    ...
    # else:
    #     logging.info("Trying to sell when inventory is zero")
    #     reward = -10000
...
for e in range(1, num_episode + 1):
    ...
    if e % 1 == 0:
        if model_name == 'DQN':
            agent.model.save('saved_models/DQN_v2' + str(e) + '.h5')
